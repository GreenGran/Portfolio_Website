...
import ActiveSectionContextProverder from './context/active-section-context'
...
export const metadata = {
  title: 'John | Perspnal Pertfolio ',
  description: 'John Almozlino is a full-stack dev',
}
